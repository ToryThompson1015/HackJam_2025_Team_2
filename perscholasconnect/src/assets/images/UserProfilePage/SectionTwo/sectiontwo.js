...
const SectionTwo = () => {
  return (
    ...
    <h2 className="text-3xl font-bold mb-6 text-center">Celebrate Your Milestones</h2>
    ...
    <div>
      ...
      <ul className="flex flex-wrap gap-4 text-sm">
        ...
        <li className="bg-green-600 px-3 py-1 rounded-full">✅ Increased Responsibility</li>
        <li className="bg-gray-300 text-gray-700 px-3 py-1 rounded-full">⬜ New Certification</li>
        <li className="bg-gray-300 text-gray-700 px-3 py-1 rounded-full">⬜ Salary Increase</li>
        <li className="bg-gray-300 text-gray-700 px-3 py-1 rounded-full">⬜ Attend 5 Networking Events</li>
      </ul>
    </div>
  </div>
  );
